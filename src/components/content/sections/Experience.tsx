...
const dataset = [
  {
    ...
    contentRightLabel: "Promotion from Junior Software Developer",
  ...
  },
  {
    ...
    contentRightLabel:
      "Implementing new functionalities in an open-source\n" +
...
const Experience = () => {
  return (
    <div id="experience">
      <SectionLabel label="Experience" color="rgb(28, 90, 103)" />
